...
class PersonController: ControllerBase {
    ...
    private func addPerson(name: String, city: String) -> View {
        ...
        repository.addPerson(Person(name: name, city: city))
    ...
    private func search(term: String) -> View {
        ...
        let matches = repository.People.filter({person in return person.name.lowercaseString.rangeOfString(termLower) != nil || person.city.lowercaseString.rangeOfString(termLower) != nil})
